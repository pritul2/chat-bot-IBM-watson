...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //IamOptions options = new IamOptions().Builder()
          //      .apiKey("DRMCpjxRZRMuncWkXKMiKh_3ZDn27Lm7zdkfupHoDBLv")
            //    .build();
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if(audioMessage != null && !audioMessage.getMessage().isEmpty())
                                ...
                                streamPlayer.playStream(textToSpeech.synthesize(audioMessage.getMessage(), Voice.).execute());
                            else
                                streamPlayer.playStream(textToSpeech.synthesize("No Text Specified", Voice.).execute());
